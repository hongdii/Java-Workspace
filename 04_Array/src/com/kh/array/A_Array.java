...
public class A_Array {
	 ...
	 *       정확히 얘기하자면 배열의 각 인덱스 자리에 실제값이 담김(인덱스 0 부터 시작.)
	 *       예 ) int[] a = new int[3]; // int형의 자료가 들어갈수 있는 공간을 3개 만든다.
	 *                                 // 방, 사물함 [0] [1] [2]을 3개 만듬.
	 *                                 // 인덱스는 항상 0부터 시작한다.(중요)
	 *                                 // 배열의 크기는 3, 마지막 인덱스 = 2
	 *                                 // 배열의크기 100 , 마지막 인덱스 = 99
	 *                                 // 항상 크기 = n , 마지막 인덱스 = n-1
	 */
	...
	public void method1() {
		...
		/*
		 * 변수로 이용하여 각각의 데이터를 보관하고자할때 -> 각각의 변수를 만들어서 따로관리해야함.
		 * 
		 * int num1 = 0;
		 * int num2 = 1;
		 * int num3 = 2;
		...
		// 각각의 인덱스값을 확인하기 위해서는 []불럭을 통해 내가확인하고자 하는 인덱스(방번호)를 제시해줘야함.
	...
	public void method2() {
		...
		int i = 10;//일반변수. i라는 박스에 10이라는값이 그냥 담겨있음.
		...
		System.out.println("arr : "+arr);//[I@1245fd2
	...
	public void method3() {
		 ...
		 * -> heap라는 영역에는 절~때로 빈공간이 존재할수 없기때문.
	...
	public void method4() {
		...
		for(int i = 0; i < arr.length; i++) {
			arr[i] = i + 1; // arr[0]= 1, arr[1] =2, arr[2] =3, arr[3], arr[4]
		}
	...
	public void method6() {
		...
		System.out.println("arr의 해시코드값 : "+arr.hashCode());
		/*
		 * 항상 고유한 주소값 부여, 기존에 생성되었던주소와 절!때로 겹치지 않는다.
	...
	public void method9() {
		...
		//2. 반복문을 활용해서 매번 사용자에게 과일명을 입력받아 그 값을 매~ 인덱스자리에
		//대입
		sc.nextLine();
		for(int i = 0; i < arr.length; i++) {
	...
	public void method10() {
		...
		// 1. 사용자에게 문자열 입력받기
		Scanner sc = new Scanner(System.in);
		System.out.print("문자열 입력 : ");//민경민
		String str = sc.nextLine();		
		// 2.char배열 생성해두기 (배열 크기 == 문자열의 길이만큼) 문자열.length()
	...
	public void method11() {
		// 1. 사용자에게 배열의길이 입력받은후, 해당 크기만큼 정수배열 생성
		Scanner sc = new Scanner(System.in);
		...
		// 3. 반복문 활요해서 0번인덱스부터~ 마지막인덱스까지 배열에 담긴값 출력과 동시에,
	...
	public void method12() {
		...
		//1. 반복문을 활용해서 heights배열의 0번인덱스부터 마지막인덱스까지 반복을
