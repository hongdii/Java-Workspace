...
public class D_Printf {
	 ...
	 * 
	 * System.out.printf("출력하고자하는 형식", 출력하고자하는값, 출력하고자하는값, ...);
	 * => f는 format(형식)을 의미
	...
	public void printFtest() {
		...
		System.out.printf("%-5d 진짜로?", iNum1); // %-5d : 5칸의 공간중 왼쪽정렬(음수)
		...
		System.out.printf("%C %S %% %n", ch, str); //%C, %S : 영어 알파벳일경우
		//대문자로 변경해서 출력
