...
public class ArrayForeach {
	...
	public static void main(String[] args) {
		...
		for(int num : arr2) {	// arr2라는 배열을 0번 인덱스부터 순차적으로 접근하면서 int num이라는 변수에 arr2의
								// 각 인덱스의 값을 저장함.
		...
		System.out.print("구매하고자하는 핸드폰의 이름을 입력하시오 : ");
		String pName = sc.nextLine();
		
		int count = 0;
		for(Phone ph : phones) {
			if(ph.getSeries().equals(pName)) {
				count++;
				System.out.println(ph.getName()+ph.getSeries()+" 핸드폰의 가격은 "+ph.getPrice()+"원 입니다.");
				break;
			}
		}
