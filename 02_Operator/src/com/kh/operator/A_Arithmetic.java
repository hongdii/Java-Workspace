...
public class A_Arithmetic {
	...
	public void method() {
		...
		// num1+num2로 출력해버리면 String처럼 각각의 숫자 10과 3을 찍기 때문에
		// 괄호로 묶어줘서 덧셈연산이 먼저 실행되도록 한다.
		
		System.out.println("num1 - num2 = "+(num1-num2));
		// 뺌셈의 경우 괄호로 묶어주지 않으면 String처럼 각각 숫자로 인식하기때문에 오류발생
		
		System.out.println("num1 * num2 = "+ num1*num2 );
		System.out.println("num1 / num2 = "+ num1/num2);
		System.out.println("num1 % num2 = "+ num1%num2);
		// 곱셈, 나눗셈, 모듈러의 경우 덧셈보다 우선순위가 높기때문에 괄호로 묶어주지 않아도
		...
		double a = 35; // 35.0이라는 값이 a에 들어감
		double b = 10; // 10.0
		
		System.out.println(a / b); // 실수끼리의 실행결과?? 3.5
