...
public class F_Logical {
	 ...
	 * 논리 연산자
	 * 두 개의 논리값을 연산하는 연산자
	 * 논리값과 (논리연산자) 논리값 -> 결과값도 논리값
	 * 
	 * AND 연산자 : 논리값 && 논리값
	 * 			   왼쪽, 오른쪽 논리값이 둘다 TRUE여야 최종결과 TRUE가 반환됨
	 * 
	 * OR 연산자 : 논리값 || 논리값
	 * 			  왼쪽, 오른쪽 논리값중 어느 하나라도 TRUE면 최종 결과가 TRUE
	 * 
	 */
	...
	public void method1() {
		...
		boolean result = (num > 0) && (num % 2 == 0) ? true : false;
		// && 의미 : 그리고, ~이면서, ~이고
	...
	public void method2() {
		...
		boolean result = 1 <= num && num <= 100 ? true : false ;
		// 자바에서는 1 <= num <= 100 과 같은 연산 불가능
		
		System.out.println("사용자가 입력한 정수값이 1이상 100이하의 수 입니까? "+result);
		
		/*
		 * &&(AND) : 그리고, ~이면서, ~이고, 뿐만아니라
		 * 			두개의 조건 모두 true여야 결과값도 true
		 * 			둘중 하나라도 false일 경우 결과값은false
		 */
	}
	...
	public void method3() {
		...
		/*
		 * || (OR) : 또는, ~이거나
		 * 두 개의 조건중 하나라도 TRUE일 경우 최종 결과값은 true
