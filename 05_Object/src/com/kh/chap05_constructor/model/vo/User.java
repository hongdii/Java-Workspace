...
public class User {
	 ...
	 * 생성자를 작성하는 목적
	 * 1. 객체를 생성해주기 위한 목적
	 * 2. 객체 생성 뿐만 아니라 매개변수로 전달된 값을 곧바로 필드로 대입(초기화)시킬 목적
	 * 
	 * 생성자 작성시 주의사항
	...
	public User() {
		 ...
		 * JVM이 클래스를 컴파일할때 기본생성자가 없는 경우 항상 자동으로 만들어주기 때문.(매개변수있는 생성자가 없는 경우)
	...
	public User(String userId, String userPwd, String userName, int age, char gender) {
		...
		/*
		 * 생성자 내부에서 생성자끼리 중복되는 코드가 있는 경우, this생성자를 통해 같은 클래스 내에 있는 다른 생성자
