...
//		}
	...
	public void method2() {
		// 사용자에게 구매할 과일명(사과, 바나나, 북숭아)을 입력받아
		// 각 과일마다 가격을 출력(사과 1000원, 바나나 2000원, 복숭아 5000원)
		// 잘못된 과일 입력시 저희 가게에서 판매하는 과일이 아닙니다. 출력
		// xx의 가격은 xxxx원입니다.
		
		Scanner sc = new Scanner(System.in);
		
		System.out.print("구매할 과일명(사과, 바나나, 북숭아)을 입력하시오 : ");
