...
public class B_While {
	 ...
	 * }
	 * 
	 * for문과 다르게 초기식, 증삼식 필수가 아님.
	 * 
	 * 분기문에서 초기식, 증감식없이 작성하는법을 배울 예정.
	 */
	...
	public void method2() {
		...
		for(int i=1 ; i<=10 ; i++) {
			if(i%2!=0) {		// i%2!=0 과 i % 2 == 1 은 동일하게 홀수값을 구하는 조건
				System.out.print(i+" ");
			}
		}
		...
		int i = 1;
		while(i<10) {	// 어차피 홀수만 출력할 것이기에 10 미만으로 조건잡음
			if(i%2!=0) {
				System.out.print(i+" ");
			}
			i++;
