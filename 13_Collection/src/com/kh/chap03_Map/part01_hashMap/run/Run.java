...
public class Run {
	...
	public static void main(String[] args) {
		...
		/*
		 * 계층구조를 보면 List나 Set 계열은 Collection을 구현한 클래스 => 데이터를 추할때 add메소드
		...
		Snack s = hm.get("칸초"); //제네릭설정을 해놧기 때문에 Snack타입 객체로 강제형변환 하는과정이 생략되었다.
