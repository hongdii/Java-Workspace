...
public class Run {
	...
	public static void main(String[] args) {
		...
		//Student s1 = new Student("민경민", 31,100); // 민경민31100 
		//Student s2 = new Student("민경민", 31,99); // 민경민31100 
		//s1.equals(s2)
		
		
		System.out.println(hs2);
		// 저장 순서 유지 X , 중복 저장 o -> 동일객체로 판단되지 않기 때문.
		// 값이 추갈될때 equals(), hashCode()로 비교 후 둘가 결과가 true면 동일객체로 판단.
		...
		// 만약 위 2개의 메서드를 내가 원하느 형태로 바꿔서 중복저장이 안되게 하고 싶다면 오버라이딩을 해야줘야함.
		...
		// .iterator() : List계열과 Set계열에서만사용 가능함.
