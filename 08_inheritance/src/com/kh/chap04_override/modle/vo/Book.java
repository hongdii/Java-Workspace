package com.kh.chap04_override.modle.vo;
...
public class Book /*extends Object*/ {
	...
	// alt+shift+s - generater constructor using feild
	 ...
	 * - 반환형이 동일해아함
	 * - 부모메서드의 접근제한자 보다 같거나 공유범위가 더 커야함 (public - default - protected - private)
	 * 		ex) 만약 부모메서드의 접근제한자가 protected면 자식은 public, protected여야함
	 * 		=> 규약의 개념이 들어가 있음(재정의 하기위해선 위의 성립조건은 최소한 지켜야한다는 의미)
	 * 
	 * @Override 어노테이션
	 * - 생략가능(명시를 안해도 부모메소드와 형태가 같으면 오버라이딩이 생김)
	 * - 어노테이션을 붙이는 이유
	 * 	> 잘못 기술했을 경우(성립조건과 다르게) 오류를 알려주기 때문에 다시한번 검토할 수 있게 유도한다.
	 * 	> 혹시라도 부모메소드가 나중에 수정이 되었을 경우 오류를 알려주기 때문에 검토할수 있게 유도한다.
	 * 	> 이 메소드가 오버라이딩된 메소드라는걸 알리고자 하는 목적.★중요
	 * 
	 */
	@Override
